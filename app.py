...
# --- LOGIN HTML WITH SINGLE BLUE ANIMATED GLOW BORDER ---
LOGIN_HTML = '''
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        :root { --bg: #030508; --primary: #0088ff; --sec: #0055ff; }
        ...
        /* --- BACKGROUND FLOATING GLOW DOTS (PURE BLUE) --- */
        .glow-blob {
            position: absolute;
            border-radius: 50%;
            background: #0088ff;
        ...
        /* --- SINGLE BLUE ROTATING BORDER WRAPPER --- */
        .card-wrapper {
            position: relative;
            z-index: 2;
            width: 100%;
        ...
        .lock-container { width: 65px; height: 65px; background: rgba(0, 136, 255, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; border: 1px solid var(--primary); }
...
# --- MODERN ADMIN HTML WITH TAB PERSISTENCE ---
ADMIN_HTML = '''
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        :root { --bg: #06090e; --card: #0d1117; --accent: #0088ff; --sec: #0055ff; --text: #c9d1d9; --border: rgba(255,255,255,0.08); }
        ...
        .btn-primary { background: linear-gradient(45deg, var(--sec), var(--accent)); color: #fff; }
