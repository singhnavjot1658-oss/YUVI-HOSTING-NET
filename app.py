...
def index():
    ...
    # FIXED: Theme persistent state recovery including pre-ui presets
    user_theme = db.get("themes", {}).get(user_name, {"color": "#00ffff", "size": 38, "speed": 4, "preset_ui": "default", "theme_type": "default"})
    ...
    return render_template("index.html", 
                           ...
                           user_preset_ui=user_theme.get("preset_ui", "default"),
                           user_theme_type=user_theme.get("theme_type", "default"))
...
def save_theme():
    ...
    # FIXED: Save custom UI theme attributes along with pre-UI presets
    ...
    current_theme.update({
        ...
        "preset_ui": data.get("preset_ui", current_theme.get("preset_ui", "default")),
        "theme_type": data.get("theme_type", data.get("preset_ui", current_theme.get("theme_type", "default")))
    })
