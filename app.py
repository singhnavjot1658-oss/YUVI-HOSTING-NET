...
def index():
    ...
    # User panel ka UI hatane ke baad, normal users ko access block ka message dikhega.
    return "<h3>Access Denied: User Panel is currently disabled by Admin.</h3>", 403
