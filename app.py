...
<body>
    <div class="container">
        <div class="header">
            <h2><i class="fa-solid fa-crown" style="color:var(--neon-blue);"></i> OWNER CONTROL PANEL</h2>
            <a href="/logout" class="btn btn-logout"><i class="fa-solid fa-power-off"></i> LOGOUT</a>
        </div>

        <div class="section-header">
            <h3><i class="fa-solid fa-server"></i> SECTION 1: SERVER HEALTH & QUICK ACTIONS</h3>
            <span>Live Diagnostics</span>
        </div>
        <div class="grid">
            <div class="card">
                <div class="card-title"><i class="fa-solid fa-microchip"></i> LIVE RESOURCE MONITOR</div>
            ...
            <div class="card">
                <div class="card-title"><i class="fa-solid fa-bolt"></i> EMERGENCY CONTROLS</div>
        ...
        <div class="section-header">
            <h3><i class="fa-solid fa-user-gear"></i> SECTION 2: USER MANAGEMENT</h3>
            <span>Create & Manage Accounts</span>
        </div>
        <div class="card">
            <div class="card-title"><i class="fa-solid fa-user-plus"></i> ADD NEW SUBSCRIBER</div>
        ...
        <div class="section-header">
            <h3><i class="fa-solid fa-bullhorn"></i> SECTION 3: BROADCAST STATION</h3>
            <span>Push Notifications to Dashboard</span>
        </div>
        <div class="card">
            <div class="card-title"><i class="fa-solid fa-paper-plane"></i> DISPATCH ALERT MESSAGE</div>
            <form action="/admin/broadcast" method="post" class="input-group">
                ...
                <button type="submit" class="btn btn-primary" style="width:100%;"><i class="fa-solid fa-paper-plane"></i> Send Broadcast</button>
            </form>
        </div>

        <div class="section-header">
            <h3><i class="fa-solid fa-shield-halved"></i> SECTION 4: SECURITY & INTEGRATION</h3>
            <span>Admin Auth & Credentials</span>
        </div>
        <div class="grid">
            <div class="card">
                <div class="card-title"><i class="fa-solid fa-lock"></i> UPDATE ADMIN CREDS</div>
            ...
            <div class="card">
                <div class="card-title"><i class="fa-solid fa-robot"></i> TELEGRAM BOT SECRET API KEY</div>
        ...
        <div class="section-header">
            <h3><i class="fa-solid fa-code"></i> SECTION 5: BOT INTEGRATION API</h3>
            <span>REST Endpoints</span>
        </div>
        <div class="card">
            <div class="card-title"><i class="fa-solid fa-plug"></i> BOT ENDPOINT DOCUMENTATION</div>
...
BODY:
{
    ...
    "expiry": "2026-12-31T23:59"
        ...
        <div class="section-header">
            <h3><i class="fa-solid fa-users"></i> SECTION 6: SUBSCRIBER DIRECTORY</h3>
            <span>Active Subscriptions</span>
        </div>
        <div class="card">
            <div class="card-title"><i class="fa-solid fa-database"></i> SUBSCRIBER MANAGEMENT</div>
            {% if users %}
