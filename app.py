...
def index():
    ...
    # Dynamic dynamic rendering standard page index template
...
if __name__ == "__main__":
    # FIX: use_reloader=False lagaya hai taaki upload/logs ke file changes par Flask server crash/restart na ho
