...
if fb_creds_json:
    try:
        # Pura saaf safai ke sath load karega
        cred_dict = json.loads(fb_creds_json.strip())
        ...
        # Dummy init taaki website crash na ho aur 500 error na aaye
        pass
else:
    print("WARNING: FIREBASE_CREDS Environment Variable missing!")
