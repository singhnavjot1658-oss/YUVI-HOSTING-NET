...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>JUBARAJ Control Center | Premium Hosting</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Users List table & premium layout */
        .user-item { 
...
<body>
    <div class="container">
        <div class="header">
            <h2><i class="fa-solid fa-bolt"></i> JUBARAJ PREMIUM PORTAL</h2>
