...
# --- LOGIN HTML WITH ANIMATED GLOW BORDER & FLOATING DOTS ---
LOGIN_HTML = '''
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* --- ROTATING GLOWING BORDER WRAPPER --- */
        .card-wrapper {
            position: relative;
            z-index: 2;
            width: 100%;
...
# --- MODERN ADMIN HTML WITH EASY API COPY & CHANGE CREDENTIALS ---
ADMIN_HTML = '''
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .header { display: flex; justify-content: space-between; align-items: center; padding: 12px 15px; background: #0d1117; border-bottom: 1px solid var(--border); position: sticky; top:0; z-index: 100;}
    ...
    <div class="container">
        ...
        <div id="tab-settings" class="tab-content">
            <div class="card">
                ...
                <form action="/admin/update_credentials" method="post" class="input-group">
