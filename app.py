...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        pre { background: #010204; color: #00ffff; padding: 10px; border-radius: 8px; font-size: 11px; overflow-x: auto; border: 1px solid rgba(0, 255, 255, 0.1); font-family: monospace; }
    </style>
    <script>
...
<body>
    <div class="container">
        <div class="header">
            <h2><i class="fa-solid fa-crown" style="color:var(--neon-blue);"></i> OWNER CONTROL</h2>
            <a href="/logout" class="btn btn-logout"><i class="fa-solid fa-power-off"></i> LOGOUT</a>
        </div>

        <div class="section-title"><i class="fa-solid fa-user-gear"></i> SECTION 1: USER MANAGEMENT</div>
        <div class="card">
        ...
        <div class="section-title"><i class="fa-solid fa-bullhorn"></i> SECTION 2: BROADCAST SYSTEM</div>
        <div class="card">
            <h3><i class="fa-solid fa-paper-plane"></i> BROADCAST STATION</h3>
        ...
        <div class="grid">
            <div class="card">
                <h3><i class="fa-solid fa-lock"></i> UPDATE ADMIN CREDS</h3>
        ...
        <div class="section-title"><i class="fa-solid fa-code"></i> SECTION 4: BOT INTEGRATION API</div>
        <div class="card">
            <h3><i class="fa-solid fa-plug"></i> BOT ENDPOINT DOCUMENTATION</h3>
...
BODY:
{
    ...
    "expiry": "2026-12-31T23:59"
        ...
        <div class="section-title"><i class="fa-solid fa-users"></i> SECTION 5: SUBSCRIBER DIRECTORY</div>
        <div class="card">
