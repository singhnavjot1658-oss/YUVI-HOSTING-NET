...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .login-card { position: relative; z-index: 10; background: var(--glass); padding: 40px 35px; border-radius: 25px; width: 100%; max-width: 420px; text-align: center; border: 1px solid rgba(0, 255, 255, 0.15); backdrop-filter: blur(20px); box-shadow: 0 25px 45px rgba(0,0,0,0.5); }
...
def create_user():
    ...
    # Form data process validation fix
