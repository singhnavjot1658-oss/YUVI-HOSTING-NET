...
<head>
    ...
    <style>
        ...
        input, select, textarea { width: 100%; padding: 12px; border-radius: 10px; border: 1px solid #333; background: rgba(0,0,0,0.3); color: white; }
...
def index():
    ...
    # Check if there is a broadcast notification for this user
    user_broadcast = db["users"].get(user_name, {}).get("broadcast", "")
