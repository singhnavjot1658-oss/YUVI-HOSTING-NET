...
<body>
    <div class="container">
        ...
        <div class="section-title"><i class="fa-solid fa-users"></i> SECTION 1: SUBSCRIPTION & BROADCAST</div>
        <div class="grid">
            <div class="card">
        ...
        <div class="section-title"><i class="fa-solid fa-key"></i> SECTION 2: SECURITY & BOT API KEYS</div>
        <div class="grid">
            <div class="card">
                <h3><i class="fa-solid fa-shield-halved"></i> UPDATE ADMIN CREDS</h3>
        ...
        <div class="section-title"><i class="fa-solid fa-code"></i> SECTION 3: TELEGRAM BOT INTEGRATION API</div>
        <div class="card" style="margin-bottom: 20px;">
            <h3><i class="fa-solid fa-plug"></i> BOT ENDPOINT DOCUMENTATION</h3>
            <p style="font-size: 11px; margin-bottom: 10px; opacity: 0.8; font-family: sans-serif;">Aap apne Telegram Bot Python Script se niche diye gaye JSON payload and API URL ka use kar sakte hain user plan create karne ke liye:</p>
            <pre>
...
BODY:
{
    ...
    "expiry": "2026-12-31T23:59"
        ...
        <div class="section-title"><i class="fa-solid fa-users-gear"></i> SECTION 4: ACTIVE SUBSCRIBERS DIRECTORY</div>
        <div class="card">
