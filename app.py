        ...
        if main_file:
            ...
            if main_file.endswith('.py'):
                ...
                if os.path.exists(req_path):
                    ...
                    log_file.flush()
                    try:
                        # Popular telegram aur python libraries ka mapping table
                        package_mapping = {
                            ...
                            if line.startswith("import ") or line.startswith("from "):
                                ...
                                if len(parts) > 1:
                                    if parts[0] == "from":
                                        ...
                                        mod = parts[1].split(',')[0].split('.')[0].strip()
                                    
                                    # Standard libraries ko bypass kiya
                        ...
                        for mod in modules_to_install:
                            ...
                            log_file.flush()
                            subprocess.run(["pip", "install", install_name], stdout=log_file, stderr=log_file)
