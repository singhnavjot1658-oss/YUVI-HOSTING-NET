...
# --- OFFICIAL FIREBASE ADMIN SETUP ---
# Apni serviceAccountKey.json file ka sahi path yahan dalein
# Aur databaseURL & storageBucket ko apne Firebase Console se replace karein
