...
def enforcement_loop():
    while True:
        ...
        time.sleep(3) # Check frequency optimized to 3 seconds for fast termination
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Updated Header Style matching YUVI CODEX */
        .header { 
            display: flex; 
...
def index():
    ...
    # Calculate Iso/Timestamp formats of Expiry for JavaScript execution
    ...
    # Dynamic inject template of index.html for live countdown top right
    # (Removed youtube/telegram social icon markers internally)
    return render_template("index.html", 
                           apps=apps_list, 
                           username=user_name,
                           plan_expiry=expiry_display,
                           js_expiry=js_expiry_iso, # Used in JS countdown clock on top-right
